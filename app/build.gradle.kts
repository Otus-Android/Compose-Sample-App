...
android {
    ...
    defaultConfig {
        ...
        // Read the keys from local.properties using dot-notation
        val marvelPublicKey: String = localProperties.getProperty("marvel.public.key") ?: ""
        val marvelPrivateKey: String = localProperties.getProperty("marvel.private.key") ?: ""

        // Inject keys as BuildConfig fields
